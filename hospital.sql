...
select p.name, h.name, a.reservation_datetime from appointment a join hospital h on a.hospital_id = h.hospital_id join patient p on p.patient_id = a.patient_id;
